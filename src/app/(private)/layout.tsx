      ...
      <aside className="w-72 border-r border-white/5 bg-black flex flex-col z-[110]">
        <div className="p-8">
          <Link href="/" className="group flex items-center gap-3 mb-12">
            <div className="w-8 h-8 bg-zinc-800 text-white flex items-center justify-center font-black rounded-lg group-hover:bg-white group-hover:text-black transition-colors">W</div>
          ...
          <nav className="flex flex-col gap-2">
            ...
            <Link href="/collection" className="group flex items-center justify-between px-4 py-3 rounded-xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
              <span className="text-sm font-black uppercase tracking-widest text-zinc-400 group-hover:text-white transition-colors">My Cards</span>
              <span className="text-xs opacity-0 group-hover:opacity-100 transition-opacity">→</span>
            </Link>
            <Link href="/pull" className="group flex items-center justify-between px-4 py-3 rounded-xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
              <span className="text-sm font-black uppercase tracking-widest text-zinc-400 group-hover:text-white transition-colors">Open Pack</span>
              <span className="text-xs opacity-0 group-hover:opacity-100 transition-opacity">✦</span>
            </Link>
          </nav>
          ...
          <nav className="flex flex-col gap-2">
            ...
            <Link href="/roster" className="group flex items-center justify-between px-4 py-2 rounded-xl text-zinc-500 hover:text-zinc-300 transition-colors">
        ...
        <div className="mt-auto p-8 border-t border-white/5 bg-zinc-950/50">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] font-black uppercase text-zinc-500 tracking-widest italic">Rookie Collector</span>
            </div>
          </div>
        </div>
      </aside>
